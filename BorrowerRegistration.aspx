...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <select class="form-control"  runat="server" id="txt_proof" >
    ...
    <option value="VoterId">VoterId</option>
                 ...
                 <asp:RequiredFieldValidator ID="rfv_txt_proof" runat="server" ControlToValidate="txt_proof" ErrorMessage="please select one value"  ValidationGroup="Controls" ForeColor="Red" InitialValue="Select">*</asp:RequiredFieldValidator>
</div>
        ...
        <div class="col-md-6">
             <input type="file" id="txt_prooffile" runat="server"  class="form-control input-md" />
                 ...
                 <asp:RegularExpressionValidator ID="rev_txt_prooffile" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.png|.jpg|.gif)$"
    ControlToValidate="txt_prooffile" runat="server" ForeColor="Red" ErrorMessage="Please select a valid image or PDF File file." Text="*"
    Display="Dynamic" ValidationGroup="Controls" />
        ...
        <div class="col-md-6">
             <input type="file" id="txt_photo" runat="server" class="form-control input-md"/>
                    ...
                    <asp:RegularExpressionValidator ID="ref_txt_photo" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.png|.jpg|.gif)$"
    ControlToValidate="txt_photo" runat="server" ForeColor="Red" ErrorMessage="Please select a valid image or PDF File file." Text="*"
    Display="Dynamic" ValidationGroup="Controls" />
