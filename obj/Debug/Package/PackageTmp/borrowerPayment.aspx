<%@ Page Title="" Language="C#" MasterPageFile="~/THFinance.Master" AutoEventWireup="true" CodeBehind="borrowerPayment.aspx.cs" Inherits="THFinance.borrowerPayment" %>
    ...
    <div runat="server" id="payregistration" visible="false">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddl_Borroerpayeename" runat="server" OnSelectedIndexChanged="ddl_Borroerpayeename_SelectedIndexChanged" CssClass="form-control input-md" AutoPostBack="true"></asp:DropDownList>
