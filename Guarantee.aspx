            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select class="form-control" runat="server" id="txt_guaranteeproof">
                      ...
                      <asp:RequiredFieldValidator ID="rfv_txt_guaranteeproof" runat="server" ControlToValidate="txt_guaranteeproof" ErrorMessage="please select one value" ValidationGroup="Controls" ForeColor="Red" InitialValue="Select">*</asp:RequiredFieldValidator>
                </div>
